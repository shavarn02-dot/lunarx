...
start "LUNARX Engine (Port 8000)" cmd /k python -m uvicorn app.api_server:app --port 8000 --host 127.0.0.1
...
start "LUNARX Local UI (Port 3030)" cmd /k "cd /d lunar-x && npm run dev"
